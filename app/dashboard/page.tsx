...
// //           : `${API_URL}?status=${viewFilter}&page=${page}&limit=${limit}`;
...
// //       console.log("Products set in state:", data.data);
// //       setMeta({
// //         total: data.total,
...
// import { createProduct, deleteProductPermanent, toggleArchiveProduct, updateProduct } from '../services/productService';
...
//     };
//     if (editing) {
//       const updated = await updateProduct(token!, editing.id, data);
//       setProducts((prev: any) =>
//         prev.map((p: any) => (p.id === editing.id ? updated : p))
//       );
//       setEditing(null);
//     } else {
//       const created = await createProduct(token!, data);
...
//   const success = await deleteProductPermanent(token!, id);
...
//   const updated = await updateProduct(token!, id, data);
